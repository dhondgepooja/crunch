 ...
 * </pre>
 */
public final class FromHCat <T extends SpecificRecord> {
  HCatAvroSourceTarget<T> target;
  ...
  public HCatAvroSourceTarget<T> avroTable(String database, String table){
    target = new HCatAvroSourceTarget<>(database, table);
    return target;
  }
